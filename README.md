> Unofficial modified fork of [ReadAny](https://github.com/codedogQBY/ReadAny).
> Modified by Capricorn-alpha and distributed under GPL-3.0-or-later.
> See [NOTICE.md](NOTICE.md) for modification and redistribution notes.
