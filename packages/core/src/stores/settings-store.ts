...
export const useSettingsStore = create<SettingsState>()(
  withPersist("settings", (set, get, _api) => ({
    ...
    const retiredFreeProvider = "micro" + "soft";
    if ((migrated.translationConfig?.provider?.id as string | undefined) === retiredFreeProvider) {
      migrated.translationConfig = {
        ...migrated.translationConfig,
        provider: defaultTranslationConfig.provider,
      };
    }
    if (typeof migrated.networkEnabled !== "boolean") {
