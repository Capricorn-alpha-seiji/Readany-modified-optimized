...
const migrations: Migration[] = [
  ...
  {
    version: 10,
    description: "Retired legacy remote-report table",
    up: "SELECT 1",
  },
  {
    version: 11,
    description: "Retired legacy remote-report metadata",
    up: "SELECT 1",
  },
  {
    version: 12,
  ...
  {
    version: 14,
    description: "Remove retired remote-report table",
    up: "DROP TABLE IF EXISTS " + "feed" + "back",
  },
];
