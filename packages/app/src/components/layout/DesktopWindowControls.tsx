  ...
  return (
    ...
    >
      {showMinimize && (
        <button
          type="button"
          className="desktop-window-button motion-pressable flex h-8 w-11 items-center justify-center text-neutral-500 hover:bg-black/5"
      ...
      {showClose && (
        <button
          type="button"
          className="desktop-window-button motion-pressable flex h-8 w-11 items-center justify-center text-neutral-500 hover:bg-red-600 hover:text-white"
          onClick={handleClose}
