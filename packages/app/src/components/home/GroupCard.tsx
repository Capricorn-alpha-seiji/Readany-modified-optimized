...
function CoverLayer({ book, index, total }: { book: Book; index: number; total: number }) {
  ...
  return (
    <div
      className="book-cover-shadow absolute aspect-[28/41] overflow-hidden rounded"
      style={{
        right: offset.right,
...
export const GroupCard = memo(function GroupCard({
  ...
  return (
    <div className="motion-clickable motion-hover-lift group/card relative flex h-full cursor-pointer flex-col justify-end">
      <div className="relative aspect-[28/41] w-full">
        <button
          type="button"
          className="book-cover-shadow relative h-full w-full overflow-hidden rounded bg-muted/70 group-hover/card:book-cover-shadow"
          onClick={() => {
        ...
        <button
          type="button"
          className="motion-pressable absolute right-1 bottom-1 z-20 rounded-md bg-black/30 p-0.5 opacity-0 backdrop-blur-sm group-hover/card:opacity-100"
          onClick={(event) => {
