...
export function OnboardingModal() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-background">
      ...
      <div className="readany-panel-enter relative w-[850px] max-w-[95vw] h-[580px] max-h-[90vh] overflow-hidden rounded-[2rem] border border-border/50 bg-card/90 shadow-2xl backdrop-blur-2xl flex flex-col">
