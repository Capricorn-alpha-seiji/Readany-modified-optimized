...
export function SyncSettings() {
  ...
  }, [ensureNetworkEnabled, syncNow, t]);
  ...
  }, [ensureNetworkEnabled, forceFullSync, t]);
              ...
              <div className="mt-2 w-48">
                <div className="h-1.5 w-full overflow-hidden rounded-full bg-muted">
                  {progress.phase === "database" ? (
                    ...
                    <div
                      className="motion-scale-progress h-full rounded-full bg-primary"
                      style={{
                        "--motion-progress": (progressPercent() ?? 0) / 100,
                      } as CSSProperties}
                    />
                  )}
                </div>
