    ...
    <div className="space-y-6 p-4 pt-3">
      ...
      <section className="rounded-lg bg-muted/60 p-4">
        <h2 className="mb-4 text-sm font-medium text-foreground">
          {t("settings.networkAccess", "联网权限")}
        </h2>
        <div className="flex items-center justify-between gap-4">
          <div>
            <span className="text-sm text-foreground">
              {t("settings.allowNetworkAccess", "允许软件联网")}
            </span>
            <p className="mt-1 text-xs leading-5 text-muted-foreground">
              {t(
                "settings.allowNetworkAccessDesc",
                "关闭后将阻断 AI Provider、翻译/TTS、WebDAV/S3/LAN 同步、远程字体和模型下载等网络请求；本地阅读与本地文件不受影响。",
              )}
            </p>
          </div>
          <Switch
            ...
            aria-label={t("settings.allowNetworkAccess", "允许软件联网")}
          />
        </div>
      </section>
