...
export function ReaderToolbar({
  ...
  return (
    <div
      className={`readany-toolbar-motion absolute left-0 right-0 top-2 z-40 flex h-10 items-center justify-between bg-background/95 backdrop-blur-sm px-2 shadow-sm ${
        isVisible
