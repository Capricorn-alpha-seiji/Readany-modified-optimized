...
export function FooterBar({
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div
        className={`readany-toolbar-motion absolute bottom-0 left-0 right-0 z-50 flex flex-col bg-background/95 backdrop-blur-sm shadow-[0_-1px_3px_rgba(0,0,0,0.05)] ${
          isVisible
      ...
      >
        ...
        {showTTS && ttsExpanded && (
          <div className="readany-panel-enter border-b border-border/40 px-4 py-3 space-y-3">
            {/* Engine selection */}
        ...
        <div className="flex h-10 items-center gap-3 px-3">
          ...
          <button
            type="button"
            className="motion-pressable flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-muted-foreground hover:bg-muted hover:text-foreground"
            onClick={onPrev}
          >
            ...
            <div className="flex flex-1 items-center gap-2.5 min-w-0">
              ...
              <div className="relative flex-1 h-7 flex items-center group">
                <div className="absolute inset-x-0 h-[3px] rounded-full bg-muted/60 overflow-hidden">
                  <div
                    className="motion-scale-progress h-full bg-primary/70 rounded-full"
                    style={{ "--motion-progress": displayPct / 100 } as CSSProperties}
                  />
                </div>
                <input
                  type="range"
