...
const NOTE_TOOLTIP_STYLES = `
  .foliate-note-tooltip {
    ...
    transition: opacity var(--motion-fast, 120ms) var(--motion-ease, cubic-bezier(0.16, 1, 0.3, 1)), transform var(--motion-fast, 120ms) var(--motion-ease, cubic-bezier(0.16, 1, 0.3, 1)); /* MOTION-OPTIMIZED */
